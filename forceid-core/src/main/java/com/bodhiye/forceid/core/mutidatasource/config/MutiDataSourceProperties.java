package com.bodhiye.forceid.core.mutidatasource.config;
 ...
 */
@Component
@ConfigurationProperties(prefix = "forceid.muti-datasource")
public class MutiDataSourceProperties {

    private String defaultDataSourceName = "dataSourceForceid";
