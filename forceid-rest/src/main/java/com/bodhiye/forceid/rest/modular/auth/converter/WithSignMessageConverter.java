package com.bodhiye.forceid.rest.modular.auth.converter;
...
import com.bodhiye.forceid.rest.config.properties.JwtProperties;
...
import com.bodhiye.forceid.rest.common.exception.BizExceptionEnum;
import com.bodhiye.forceid.rest.config.properties.JwtProperties;
import com.bodhiye.forceid.rest.modular.auth.security.DataSecurityAction;
import com.bodhiye.forceid.rest.modular.auth.util.JwtTokenUtil;
...
public class WithSignMessageConverter extends FastJsonHttpMessageConverter {
    ...
    public Object read(Type type, Class<?> contextClass, HttpInputMessage inputMessage) throws IOException, HttpMessageNotReadableException {
        ...
        if (encrypt.equals(baseTransferEntity.getSign())) {
            ...
            throw new ForceidException(BizExceptionEnum.SIGN_ERROR);
        }
