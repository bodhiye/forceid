package com.bodhiye.forceid.generator.engine.config;
...
public class ContextConfig {
    ...
    private String templatePrefixPath = "forceidTemplate/advanced";
    private String projectPath = "D:\\ideaSpace\\forceid";//模板输出的项目目录
    ...
    private String proPackage = "com.bodhiye.forceid.admin";
    private String coreBasePackage = "com.bodhiye.forceid.core";
    private String modelPackageName = "com.bodhiye.forceid.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.bodhiye.forceid.modular.system.dao";    //model的dao
