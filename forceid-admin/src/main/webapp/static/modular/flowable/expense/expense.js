...
Expense.initColumn = function () {
    return [
        ...
        {title: '申请id', field: 'id', visible: true, align: 'center', valign: 'middle'},
        {title: '申请标题', field: 'money', visible: true, align: 'center', valign: 'middle'},
        ...
        {title: '创建时间', field: 'createtime', visible: true, align: 'center', valign: 'middle'},
        {
            ...
            } else {//'<button type="button" class="btn btn-primary button-margin" onclick="Expense.findRecord(' + row.id + ')" id=""><i class="fa fa-edit"></i>&nbsp;查看</button>' +
                return '<button type="button" class="btn btn-danger button-margin" onclick="Expense.deleteRecord(' + row.id + ')" id=""><i class="fa fa-arrows-alt"></i>&nbsp;删除</button>';
            }
        }
        }
