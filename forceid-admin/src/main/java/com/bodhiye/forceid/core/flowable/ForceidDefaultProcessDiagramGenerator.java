...
package com.bodhiye.forceid.core.flowable;
 ...
 */
public class ForceidDefaultProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    public ForceidDefaultProcessDiagramGenerator() {
        this(1.0);
    }

    // The instructions on how to draw a certain construct is
    // created statically and stored in a map for performance.
    public ForceidDefaultProcessDiagramGenerator(final double scaleFactor) {
        // start event
