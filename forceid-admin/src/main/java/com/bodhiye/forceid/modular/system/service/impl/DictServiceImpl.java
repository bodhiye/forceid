...
import com.bodhiye.forceid.core.common.constant.factory.MutiStrFactory;
...
import static com.bodhiye.forceid.core.common.constant.factory.MutiStrFactory.*;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements IDictService {
    ...
    public void addDict(String dictName, String dictValues) {
        ...
        if (dicts != null && dicts.size() > 0) {
            throw new ForceidException(BizExceptionEnum.DICT_EXISTED);
        }
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new ForceidException(BizExceptionEnum.DICT_MUST_BE_NUMBER);
            }
