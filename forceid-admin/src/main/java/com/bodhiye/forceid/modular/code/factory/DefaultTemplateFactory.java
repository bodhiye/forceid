package com.bodhiye.forceid.modular.code.factory;


import com.bodhiye.forceid.ForceidApplication;
import com.bodhiye.forceid.core.CoreFlag;
import com.bodhiye.forceid.core.util.ToolUtil;
import com.bodhiye.forceid.generator.action.model.GenQo;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("bodhiye");
        genQo.setProjectPackage(ForceidApplication.class.getPackage().getName());
