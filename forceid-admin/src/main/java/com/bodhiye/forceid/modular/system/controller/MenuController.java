...
import com.bodhiye.forceid.core.common.constant.dictmap.MenuDict;
import com.bodhiye.forceid.core.common.constant.factory.ConstantFactory;
import com.bodhiye.forceid.core.common.constant.state.MenuStatus;
import com.bodhiye.forceid.core.common.exception.BizExceptionEnum;
import com.bodhiye.forceid.modular.system.model.Menu;
import com.bodhiye.forceid.modular.system.service.IMenuService;
import com.bodhiye.forceid.modular.system.warpper.MenuWarpper;
...
import com.bodhiye.forceid.core.support.BeanKit;
...
public class MenuController extends BaseController {
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        if (ToolUtil.isNotEmpty(existedMenuName)) {
            throw new ForceidException(BizExceptionEnum.EXISTED_THE_MENU);
        }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            if (menu.getCode().equals(menu.getPcode())) {
                throw new ForceidException(BizExceptionEnum.MENU_PCODE_COINCIDENCE);
            }
